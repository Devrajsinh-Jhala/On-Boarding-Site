...
const AboutUs = () => {
  return (
    ...
    >
      <p className=" md:max-w-[850px] mx-5  my-10  font-inter text-lg tracking-[-0.015em] leading-[1.4rem] text-center">
      ...
      <p className=" md:max-w-[850px] mx-5 mb-10  font-inter text-lg tracking-[-0.015em] leading-[1.4rem] text-center">
